...
MODULE TestAProfStackChk2;

(*
** This differs from TestAProfStackChk2 only in that it is linked with a
** version of module Kernel that does not install a trap handler.
*)
